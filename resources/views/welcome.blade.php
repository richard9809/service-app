                ...
                <div class="row">
                     <div class="col-md-6">
                         ...
                         <select name="ministry" id="ministry" class="form-control">
                            <option value="">Ministry of LIUD</option>
                         </select>
                     </div>

                     <div class="col-md-6">
                         <label for="eqpt" class="form-label">Equipment Name</label>
                         <input type="text" name="eqpt" class="form-control" placeholder="Equipment Name" aria-label="Equipment Name">
                     </div>

                     <div class="col-md-6 mt-2">
                        <label for="serial" class="form-label">Serial No.</label>
                        <input type="text" name="serial" class="form-control" placeholder="Serial Number" aria-label="Serial Number">
                    </div>
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <input type="text" name="reported" class="form-control" placeholder="Reported By" aria-label="Reported By">
                    </div>

                    <div class="col-md-6 mt-2">
                        <label for="mobile" class="form-label">Mobile No.</label>
                        <input type="text" name="mobile" class="form-control" placeholder="eg 0712345678" aria-label="Mobile No">
                    </div>

                    <div class="col-md-6 mt-2">
                        <label for="designation" class="form-label">Designation</label>
                        <input type="text" name="designation" class="form-control" placeholder="Designation" aria-label="Designation">
                    </div>
